...
//    public static final String video_id1 = "T5-8rkMVdCs";             // Mr Bean Cartoon
//    public static final String video_id2 = "k8_xSG2saCk";             // Pokemon Origins
    public static final String video_id3 = "MgRgiHyVGgw";           // Doraemon
...
//            Toast.makeText(Display.this, "A", Toast.LENGTH_SHORT).show();
            sendData("A\r\n");
            myFirebaseRef.child("message").setValue("System Running");
            myFirebaseRef.child("duration").setValue("20 Minutes");
            myFirebaseRef.child("motor_speed").setValue("High");
            myFirebaseRef.child("orientation").setValue("Left");
            myFirebaseRef.child("date").setValue(date);
        }
...
//            Toast.makeText(Display.this, "A", Toast.LENGTH_SHORT).show();
            sendData("A\r\n");
            myFirebaseRef.child("message").setValue("System Running");
            myFirebaseRef.child("duration").setValue("15 Minutes");
            myFirebaseRef.child("motor_speed").setValue("High");
            myFirebaseRef.child("orientation").setValue("Left");
            myFirebaseRef.child("date").setValue(date);
        }
...
//            Toast.makeText(Display.this, "A", Toast.LENGTH_SHORT).show();
            sendData("A\r\n");
            myFirebaseRef.child("message").setValue("System Running");
            myFirebaseRef.child("duration").setValue("10 Minutes");
            myFirebaseRef.child("motor_speed").setValue("High");
            myFirebaseRef.child("orientation").setValue("Left");
            myFirebaseRef.child("date").setValue(date);
        }
...
//            Toast.makeText(Display.this, "B", Toast.LENGTH_SHORT).show();
            ...
            myFirebaseRef.child("message").setValue("System Running");
            myFirebaseRef.child("duration").setValue("20 Minutes");
            myFirebaseRef.child("motor_speed").setValue("Medium");
            myFirebaseRef.child("orientation").setValue("Left");
            myFirebaseRef.child("date").setValue(date);
        }
...
//            Toast.makeText(Display.this, "C", Toast.LENGTH_SHORT).show();
            ...
            myFirebaseRef.child("message").setValue("System Running");
            myFirebaseRef.child("duration").setValue("20 Minutes");
            myFirebaseRef.child("motor_speed").setValue("Low");
            myFirebaseRef.child("orientation").setValue("Left");
            myFirebaseRef.child("date").setValue(date);
        }
...
//            Toast.makeText(Display.this, "D", Toast.LENGTH_SHORT).show();
            ...
            myFirebaseRef.child("duration").setValue("20 Minutes");
            myFirebaseRef.child("motor_speed").setValue("High");
            myFirebaseRef.child("orientation").setValue("Right");
            myFirebaseRef.child("date").setValue(date);
        }
